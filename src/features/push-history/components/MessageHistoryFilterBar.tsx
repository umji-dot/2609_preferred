...
export interface MessageHistoryFilterBarProps {
  onSearchClick?: () => void;
}

export function MessageHistoryFilterBar({
  onSearchClick,
}: MessageHistoryFilterBarProps) {
  ...
  return (
    <Box paddingX={24} paddingY={16}>
      <Stack direction="row" align="end">
        <Box width={160} className="shrink-0">
          <Select
            label="채널"
            fullWidth
